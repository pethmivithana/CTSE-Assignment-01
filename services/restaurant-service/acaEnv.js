...
/**
 * Azure Container Apps: point USER_SERVICE_URL at the user-service app.
 * Defaults match common *-feedo resource names; override with USER_SERVICE_ACA_APP.
 * Mesh: http://<app> (default). Set ACA_UPSTREAM_SCHEME=https for FQDN + suffix.
 */
